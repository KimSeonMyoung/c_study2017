...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		mywin32_engine::makeMiniEdit(hWnd, 0, 30, 3002); //평균
		mywin32_engine::makeMiniEdit(hWnd, 0, 60, 3003); //평균 초과 횟수
    ...
    case WM_COMMAND:
		...
		int wmId = LOWORD(wParam);
			...
			case 4001:
			{
				...
				//SetWindowText(GetDlgItem(hWnd, 3002), , 256);
				mywin32_engine::SetControlValueInt(hWnd, 3002, IfSum / nCount);
				mywin32_engine::SetControlValueInt(hWnd, 3003, extra_growth(growth, IfSum / nCount, nCount));
				mywin32_engine::SetControlValueInt,3002,IfSum/nCount;
