...
void drawTile(Graphics *pGrap, Image *pImgBasicTile, int xPos, int yPos, int nTileIndex) 
{
	//int nTileIndex = 14;
	pGrap->DrawImage(pImgBasicTile, xPos, yPos,
		g_nTileSize *(nTileIndex % g_nTileXCount), //원본 x위치
		g_nTileSize *(nTileIndex / g_nTileXCount), //원본 y위치
