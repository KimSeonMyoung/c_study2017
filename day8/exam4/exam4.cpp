...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		mywin32_engine::makeMiniEdit(hWnd, 0, 0, 3001);
		mywin32_engine::makeMiniButton(hWnd, L"합계", 120, 0, 4001);
		mywin32_engine::makeMiniEdit(hWnd, 240, 0, 3002);
		mywin32_engine::makeMiniButton(hWnd, L"빼기", 120, 30, 4002);
		mywin32_engine::makeMiniButton(hWnd, L"곱하기", 120, 60, 4003);
		mywin32_engine::makeMiniButton(hWnd, L"나누기", 120, 90, 4004);
	}
	break;
    case WM_COMMAND:
        {
...
*/
			...
			case 4002:
			{
				...
				mywin32_engine::SetControlValueInt(hWnd, 3002, nSub);
			...
			case 4003:
			{
				...
				mywin32_engine::SetControlValueInt(hWnd, 3002, nMul);
			...
			case 4004:
			{
				...
				mywin32_engine::SetControlValueInt(hWnd, 3002, nDiv);
