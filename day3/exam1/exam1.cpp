...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{
		TCHAR szBuf[256];
		wsprintf(szBuf, L"wm_down 키다운 : %d \n",
			wParam
		);
		OutputDebugString(szBuf);
	}
