...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		makeMiniEdit(hWnd, 0, 0, 3001); //국어
		makeMiniEdit(hWnd, 105, 0, 3002);  //영어
		makeMiniEdit(hWnd, 210, 0, 3003);  //수학
		makeMiniEdit(hWnd, 0, 30, 3004);  //합계
		makeMiniEdit(hWnd, 0, 60, 3005);  //평균

		makeMiniButton(hWnd, L"Ok", 315, 0, 4001);
