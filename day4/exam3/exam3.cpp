    ...
    case WM_PAINT:
        {
			...
			SolidBrush brushGreen(Color(0, 255, 0)), brushRed(Color(255, 0, 0));



			//사각형 그리기
			graphics.FillRectangle(&brushGreen, 100, 100, 200, 200);
			//외각선 그리기
			graphics.DrawRectangle(&redpen, 100, 100, 200, 200);

			//원 그리기
			graphics.FillEllipse(&brushRed, 400, 100, 200, 200);
			//외각선 그리기
			graphics.DrawEllipse(&blackpen, 400, 100, 200, 200);
