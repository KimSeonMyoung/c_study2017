    ...
    case WM_PAINT:
        {
			...
			Image imgProfile(L"Pepper publish..png");
			Graphics graphics(hdc);
			graphics.DrawImage(&imgProfile, 100, 100);
			graphics.DrawImage(&imgProfile, 300, 100, 77, 8, 97, 110, UnitPixel);
			graphics.DrawImage(&imgProfile, 100, 300, 0,0, 24, 32, UnitPixel);
