...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		CreateWindow(L"edit", NULL, WS_CHILD | WS_VISIBLE | CBS_AUTOHSCROLL | WS_BORDER,
			20, 30, 100, 25, hWnd, (HMENU)3001, hInst, NULL );

		CreateWindow(L"static", L"나이를 입력하세요.", WS_CHILD | WS_VISIBLE,
			160, 0, 150, 25, hWnd, (HMENU)-1, hInst, NULL);
		CreateWindow(L"edit", NULL, WS_CHILD | WS_VISIBLE | CBS_AUTOHSCROLL | WS_BORDER,
			180, 30, 100, 25, hWnd, (HMENU)3002, hInst, NULL );

		CreateWindow(L"button", L"눌려봐", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			300, 30, 100, 25, hWnd, (HMENU)4001, hInst, NULL );
    ...
    case WM_COMMAND:
        {
			...
			case 4001:
			{
				...
				HDC hdc = GetDC(hWnd);
				TCHAR szBuf[256];
				swprintf(szBuf, 256, L"당신의 이름은 %s 입니다. 나이는 %d살 입니다.", szName, nAge);
