    ...
    case WM_PAINT:
        {
			...
			{
				unsigned char uch;  //양수만 쓰겠다는 unsigned
				...
				testSignedByte = 127;  // 0111 1111
				testSignedByte2 = 128;   //1000 0000

				swprintf_s(szBuf, 256, L"%d , %d , %d \n", 
					(char)(testSignedByte),      // 0111 1111 -> 1000 0001 2의 보수
					(char)(testSignedByte+1),    // 1000 0000
					(char)(testSignedByte + 2)   // 1000 0001
				);
